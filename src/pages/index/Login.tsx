      ...
      <Box>
        ...
        <TermsContainer>
          ...
          <List>
            ...
            <List>
              <ListItem>본 서비스는 <Highlight>실제 수강신청 사이트가 아니며</Highlight>, 학습 목적으로 제공되는 모의 수강신청 시스템입니다. 본 서비스에서 사용하는
                학번은 <Highlight>실제 학번이 아닌, 11자리 이상의 임의로 생성된 학번</Highlight>입니다.
              </ListItem>
            </List>
          </List>
          ...
          <List>
            ...
            <List>
              <ListItem>수집하는 개인정보 항목: 본 서비스에서는 사용자가 입력한 임의의 <Highlight>학번, 비밀번호, 관심과목, 수강신청 목록을
                수집</Highlight>합니다.</ListItem>
              <ListItem>개인정보 수집 목적: 수집된 정보는 <Highlight>사용자가 저장한 과목 목록을 불러오기 위한 용도</Highlight>로만 사용됩니다. <Highlight>그 외 다른
                목적으로는 절대 사용되지 않습니다.</Highlight></ListItem>
              <ListItem>개인정보의 보유 및 이용 기간: 수집된 정보는 <Highlight>매일 자정에 자동으로 삭제</Highlight>되며, 추가적인 보관 기간은 없습니다.</ListItem>
              <ListItem>수집된 정보의 저장 위치: 수집된 정보는 <Highlight>안전한 서버에 저장</Highlight>되며, <Highlight>외부로 유출되지 않도록 보호</Highlight>됩니다.</ListItem>
            </List>
          </List>
          ...
          <List>
            ...
            <List>
              <ListItem>본 서비스에 입력된 비밀번호는 <Highlight>암호화 알고리즘을 사용하여 안전하게 보호</Highlight>됩니다. 비밀번호는 복호화가 불가능하며, <Highlight>실제
                사용하는 비밀번호가 아닌 임의의 비밀번호를 사용하는 것을 권장</Highlight>합니다.</ListItem>
            </List>
          </List>
          ...
          <List>
            ...
            <List>
              <ListItem>사용자는 언제든지 본 서비스에 제공된 개인정보의 삭제를 요청할 수 있으며, 삭제 요청은 위의 방법을 통해 처리됩니다.</ListItem>
              <ListItem>개인정보와 관련된 문의는 <Highlight>tutorialsejong@gmail.com</Highlight>으로 문의하시면 신속히 대응해드리겠습니다.</ListItem>
            </List>
          </List>
          ...
          <List>
            ...
            <List>
              <ListItem>본 서비스는 개인정보 보호법과 정보통신망법에 따라 사용자의 개인정보를 보호하기 위해 최선을 다하고 있습니다. 수집된 개인정보는 불법적인 접근, 유출, 사용을 방지하기 위해 방화벽, 암호화 통신, 접근 통제 등 적절한 보안 조치를 취하고 있습니다.</ListItem>
            </List>
          </List>
          ...
          <List>
            ...
            <List>
              <ListItem>본 서비스의 개인정보 처리방침은 법률 개정이나 서비스 변경에 따라 수정될 수 있으며, 수정된 내용은 이 페이지에서 확인 가능합니다.</ListItem>
            </List>
          </List>
          ...
          <CheckboxWrap>
            ...
            <label htmlFor="keyboardSecurity">
              안내사항을 확인하였고 서비스 이용약관 및 개인정보 수집에 동의합니다.
            </label>
          </CheckboxWrap>
        </TermsContainer>
      </Box>
