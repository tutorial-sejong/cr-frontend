...
import FilterInput from '@components/common/FilterInput.tsx';
...
function EnrollmentInfoModal({schDeptAlias, curiNo, curiNm, classNo}: EnrollmentsProps) {
          ...
          <LectureInfoContainer>
            <LectureInfoArea>
              <LectureInfoBox>
                <LectureInfoWrap>
                  <span>조직분류</span>
                  <InputWrap sizes={'s'}><p>학부</p></InputWrap>
                </LectureInfoWrap>
                <LectureInfoWrap>
                  <span>년도</span>
                  <InputWrap sizes={'s'}><p>2024</p></InputWrap>
                </LectureInfoWrap>
                <LectureInfoWrap>
                  <span>학기</span>
                ...
                <LectureInfoWrap>
                  <span>개설학과전공</span>
                  <InputWrap sizes={'l'}><p>{schDeptAlias}</p></InputWrap>
                </LectureInfoWrap>
                <LectureInfoWrap>
                  <span>학년(학기)</span>
                  <InputWrap sizes={'s'}><p></p></InputWrap>
                </LectureInfoWrap>
                <LectureInfoWrap>
                  <span>교과목번호-분반</span>
                  <InputWrap sizes={'s'}><p>{curiNo}-{classNo}</p></InputWrap>
                  <InputWrap sizes={'xl'}><p>{curiNm}</p></InputWrap>
                </LectureInfoWrap>
              </LectureInfoBox>
            </LectureInfoArea>
          </LectureInfoContainer>
