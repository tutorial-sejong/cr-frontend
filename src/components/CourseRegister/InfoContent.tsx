...
function InfoContent() {
  return (
    <>
      <Container>
        <SubTitle>2025-2학기 수강신청 연습 안내</SubTitle>
        <p>
          <span>1. 관심과목 담기:</span> 7.30.(수) 10:00 ~ 8.1.(금) 16:00
        </p>
        <p>
        ...
        <Table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>8.12.(화) 10:00 ~ 17:00</td>
            </tr>
            <tr>
              <td>2학년(3~4학기 등록 예정자)</td>
              <td>8.13.(수) 10:00 ~ 17:00</td>
            </tr>
            <tr>
              <td>1학년(1~2학기 등록 예정자)</td>
              <td>8.14.(목) 10:00 ~ 17:00</td>
            </tr>
            <tr>
              <td>전학년</td>
              <td>8.18.(금) 10:00 ~ 17:00</td>
              <Note>
                다른 학과 전공과목도 수강
                <br />
                신청 가능
